export default {
  ...
  login: {
    ...
    safeLogin: '「安全なログイン」をクリックすることで、私は、内容を読み、理解し、承諾したことを宣言します。',
    rule: '利用規定.',
    clear: '清算',
    securedlogin: '安全なログイン',
    home: 'ホームページ',
    hello: 'こんにちは',
    Mobile: 'Mobile',
    Email: 'Email',
    UserName:'UserName',
    NeedAssistance: "手伝いが必要？",
    CallCenter: "コールセンター: ",
    AssistanceTiming:"月曜日から金曜日（{start}~{end）",
    AssistanceEmail: "電子メール: "
  },
  dashboard: {
